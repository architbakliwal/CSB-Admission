...
;(function($) {
    ...
    var CloneYa = function(element, options) {
        ...
        var defaults = {
            ...
            limit: 5, //setting it to a high number, by default
                ...
                $(this).find('*').each(function() {
                    ...
                    if(labelfor) {
                        ...
                        if (match && match.length === 3) {
                            // just take the string part
                            // add the new number to it
                            $(this).attr('for', match[1] + j);
                        } else {
                            // else there was no number,
                            // this was earlier the first element
                            // just add the number to its id
                            $(this).attr('for', labelfor + j);
                        }
                    }
                    ...
                    if (name) {
                        ...
                        if (match && match.length === 3) {
                            // just take the string part
                            // add the new number to it
                            $(this).attr('name', match[1] + j);
                        } else {
                            // else there was no number,
                            // this was earlier the first element
                            // just add the number to its id
                            $(this).attr('name', name + j);
                        }
                    }
